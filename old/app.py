...
from couro.processing import process_image, predict, visualize_keypoints, calculate_2D_joint_angles, add_angles_to_keypoints, draw_2D_pose
...
def get_angles(frames, _keypoints):
  """"""
  # Store joint angles
  left_angles, right_angles = calculate_2D_joint_angles(frames, _keypoints)
  left_joint_str = ""
  right_joint_str = ""
          ...
          with col1:
            for file in uploaded_files:
              ...
              if st.button("Annotate"):
                with col2:
                  keypoints = predict(model, x)
                  left_angles, right_angles = calculate_2D_joint_angles(image, keypoints)
                  #output_overlay = draw_2D_pose(np.squeeze(image.numpy()), keypoints, left_angles, right_angles)
